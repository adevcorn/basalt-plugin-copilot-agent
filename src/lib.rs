...
fn agent_metadata() -> AgentMetadata {
    AgentMetadata {
        ...
        args: vec![
            ...
            "--available-tools=basalt-basalt_retrieval_search".into(),
            "--available-tools=basalt-basalt_read_file".into(),
            "--available-tools=basalt-basalt_write_file".into(),
            "--available-tools=basalt-basalt_list_symbols".into(),
            "--available-tools=basalt-basalt_get_related".into(),
            "--available-tools=basalt-basalt_explain_symbol".into(),
            "--available-tools=basalt-basalt_index_status".into(),
            "--available-tools=basalt-basalt_recent_changes".into(),
            "--available-tools=basalt-basalt_request_lease".into(),
            "--available-tools=basalt-basalt_release_lease".into(),
            "--available-tools=basalt-basalt_list_leases".into(),
            "--available-tools=basalt-basalt_get_conflicts".into(),
            "--available-tools=basalt-basalt_pending_diff".into(),
            "--available-tools=basalt-basalt_list_sessions".into(),
            "--available-tools=basalt-basalt_send_message".into(),
            "--available-tools=basalt-basalt_check_reply".into(),
